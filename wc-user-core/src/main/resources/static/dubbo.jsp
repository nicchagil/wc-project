...
<button type="button" onclick="formAjax('/session/springsession/buildSession?buildSession=true')">请求接口，创建Session</button>
<button type="button" onclick="formAjax('/session/springsession/buildSession?buildSession=false')">请求接口，不创建Session</button>
<hr />
