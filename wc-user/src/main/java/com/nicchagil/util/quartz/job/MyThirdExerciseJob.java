...
import com.nicchagil.util.mail.reliability.MailLogBatchSendService;
...
public class MyThirdExerciseJob implements Job {
    ...
    public void myJobBusinessMethod() {
        ...
        MailLogBatchSendService mailLogService = ApplicationContextUtils.getBean(MailLogBatchSendService.class);
